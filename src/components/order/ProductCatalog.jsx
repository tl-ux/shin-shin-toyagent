                  ...
                  <div className="mt-1 flex items-center justify-between">
                    <span className="font-bold text-primary text-base">
                      {(() => {
                        ...
                        return <div className="flex items-center">₪<span className="ml-2">{price.toLocaleString()}</span>{product.unit && <span className="text-sm text-muted-foreground font-normal ml-3">{product.unit}</span>}</div>;
                      })()}
                    </span>
